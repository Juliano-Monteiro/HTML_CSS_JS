    ...
    btn[0].addEventListener("click",()=>{
        ...
        btn_enviar.addEventListener("click",()=>{
            ...
            if(pergunta.value == 3){
                setTimeout(() => {
                    boot.src = "imagens/img (7).jpg";
                    texto.innerHTML = "Juliano tá muito afim de voceeê💕, acho que ele merece né 😁 dá uma chance para ele vaii :) 😊 ele não para de falar de você não aguento maissss rsrsrsrs 🤯<br /> <ul><li>1 Tudo bem Osvaldo?</li><li>2 Como foi o seu dia?</li><li>3 Me conta um segredo?</li><li>0 Tchau Osvaldo</li></ul>";
                }, 500);
            }
            if(pergunta.value == 0){
                setTimeout(() => {
